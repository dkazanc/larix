...
sample_data =  np.load('/home/algol/Documents/DEV/i23seg/data/sample13076_2D.npy')
...
plt.show()
#%%
print("Morphological processing the resulting mask in 2D...")
