...
(inp_simple, mask_upd) = INPAINT_EUCL_WEIGHTED(
    pars["input"],
    pars["maskData"],
...
start_time = timeit.default_timer()
(nvm_inp, mask_upd) = INPAINT_NM(
    pars["input"], pars["maskData"], pars["SW_increment"], pars["number_of_iterations"]
)
