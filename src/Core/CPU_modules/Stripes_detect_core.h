...
extern "C" {
#endif
DLS_EXPORT int StripeWeights_main(float *input, float *output, int detectors_window_height, int detectors_window_width, int angles_window_depth, int vertical_mean_window, int ncores, long angl_size, long det_X_size, long det_Y_size);
