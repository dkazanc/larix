...
int MASK_evolve_main(float *Input, unsigned char *MASK_in, unsigned char *MASK_out, float threhsold, int iterations, int connectivity, float value1, float value2, int dimX, int dimY, int dimZ)
{
    int i;
    float *maskreg_value;
...
/***************************2D Functions*****************************/
/********************************************************************/
void mask_region_MADmean(float *Input, unsigned char *MASK, float *maskreg_value, long dimX, long dimY)
{
...
void mask_region_MADmedian(float *Input, unsigned char *MASK, float *maskreg_value, long dimX, long dimY)
{
...
void mask_update4(float *Input, unsigned char *MASK, float *maskreg_value, float threhsold, long dimX, long dimY)
{
...
void mask_update8(float *Input, unsigned char *MASK, float *maskreg_value, float threhsold, long dimX, long dimY)
{
...
/***************************3D Functions*****************************/
/********************************************************************/
void mask_region_MADmean3D(float *Input, unsigned char *MASK, float *maskreg_value, long dimX, long dimY, long dimZ)
{
    float mean_final, sum_residual;
...
void mask_region_MADmedian3D(float *Input, unsigned char *MASK, float *maskreg_value, long dimX, long dimY, long dimZ)
{
...
void mask_update3D_4(float *Input, unsigned char *MASK, float *maskreg_value, float threhsold, long dimX, long dimY, long dimZ)
{
...
void mask_update3D_6(float *Input, unsigned char *MASK, float *maskreg_value, float threhsold, long dimX, long dimY, long dimZ)
{
...
void mask_update3D_8(float *Input, unsigned char *MASK, float *maskreg_value, float threhsold, long dimX, long dimY, long dimZ)
{
...
void mask_update3D_26(float *Input, unsigned char *MASK, float *maskreg_value, float threhsold, long dimX, long dimY, long dimZ)
{
